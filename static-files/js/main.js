...
class CardSliderManager {
    constructor() {
        ...
        // Guard: exit if the main container is missing
...
class AppInitializer {
    ...
    initializeApp() {
        // Initialize all managers – each should gracefully handle missing elements
        ...
        this.managers.cardSlider = new CardSliderManager(); // safe now
...
// Main DOM ready handler (only one)
